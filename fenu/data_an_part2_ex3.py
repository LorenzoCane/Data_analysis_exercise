...
energy_file =  "OutputEnergy(1)" #k_EUSO 10perc
...
fig.savefig("img/energy_hist_k10perc.pdf") #mini
...
trigger_file = "OutputTrigger(1)" #K-EUSO 10 perc
...
ax1.legend()
plt.tight_layout()
fig1.savefig("img/trigger_eff_k10perc.pdf") #mini
