...
exposure = 30000 #km^2 sr yr #mini_euso


#-----------------------------------------------------------------------
#combine output file produced by Mini-EUSO_trigger_Master22.py 

files = sorted([file for file in os.listdir() if file.startswith("output")])
...
energy_file =  "energyList" #mini_EUSO
...
fig.savefig("img/energy_hist_mini.pdf") #mini
#plt.savefig("energy_hist_k.pdf") #k
#plt.savefig("energy_hist_k10perc.pdf") #k 10perc


#-----------------------------------------------------------------------
#read event trigger file

trigger_file = combined_file #Mini-EUSO
...
ax1.legend()
plt.tight_layout()
fig1.savefig("img/trigger_eff_mini.pdf") #mini
...
print(f"Number of events expected to trigger in 1 year (Auger spectrum) : {auger_expected_part:.4e}")
print(f"Number of events expected to trigger in 1 year (TA spectrum) : {ta_expected_part:.4e}")